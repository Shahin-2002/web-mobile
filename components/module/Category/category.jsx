...
function Category({data}) {
  ...
  <div className="mt-7 w-full max-w-[500px] mx-auto flex flex-col items-center">
    ...
    <div className="flex items-center justify-between w-full">
      <p className="font-bold text-[#BA400B]" style={{ fontFamily: 'iranyekanExtrabold' }}>
        دسته‌بندی‌ها
      </p>
      <p className="text-[13px] text-[#C15323] font-medium" style={{ fontFamily: 'iranyekanExtrabold' }}>
        انتخاب سریع محصولات
      </p>
    </div>
