...
function banerFooter() {
  ...
  <div className="border rounded-2xl p-4 mt-7 flex justify-around items-center bg-gradient-to-r from-[#4AD3FF] to-[#D1F4FF]">
    <p
      className="text-[#01366A] text-sm sm:text-base leading-snug text-right font-bold"
