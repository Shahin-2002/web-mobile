...
function SwiperPage() {
  return (
    <div className="px-4">
      {' '}
      {/* فاصله از چپ و راست */}
      <div className="border-2 border-white shadow-2xl w-full max-w-[500px] rounded-[12px] mx-auto mt-6 h-[160px]">
        <Swiper
          pagination={true}
          autoplay={{
            delay: 3000, // هر 3 ثانیه بره بعدی
            disableOnInteraction: false, // اگه کاربر دست بزنه باز ادامه بده
          }}
